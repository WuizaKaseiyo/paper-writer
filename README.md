...
│   ├── fetch_latex_template/                 copy bundled ICLR/NeurIPS/AAAI template (offline)
│   │   └── templates/                        vendored iclr2026 + neurips2026 + aaai2027 (+ NOTICE)
...
| `latex venue=iclr2026` / `neurips2026` / `aaai2027` | LaTeX project (source only) | `fetch_latex_template` (bundled, offline) |
